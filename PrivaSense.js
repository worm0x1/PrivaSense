...
class PrivaSense {
    ...
    async detectIncognito() {
        ...
        return new Promise((resolve) => {
            ...
            const resolvePrivacy = (isPrivate) => {
                if (!isResolved) {
                    isResolved = true;
                    resolve(isPrivate ? this.incognitoLabels.incognito : this.incognitoLabels.normal);
                }
            };
            ...
            const checkSafariStorageAPI = async () => {
                try {
